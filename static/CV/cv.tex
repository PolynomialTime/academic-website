...
\begin{rSubsection}{University of Auckland}{Auckland, New Zealand}{Ph.D. in Computer Science}{November 2018 -- April 2022}%October 2021 (expected)}
...
\begin{rSection}{Event Organising}
	\begin{rSubsection}{}{}{}{}
		\item Local co-chair of AAMAS 2024.
		\item Co-chair of AAMAS 2024 AAAI track.
...
\begin{rSection}{Academic Services}
	\begin{rSubsection}{}{}{}{}
		\item {\bf Reviewer:} AAMAS 2024, AAMAS 2023, ICNLP 2022, BSCI 2022, Social Network Analysis and Mining.
	\end{rSubsection}
\end{rSection}
...
\begin{rSubsection}{\large\em $\bullet$ Reinforcement Learning, Multi-agent Systems \& Game Theory}{}{}{}
	\item {\bf Meta-Inverse Reinforcement Learning for Markov Games with Probabilistic Context Variables}\\
		\textbf{Yang Chen}, Xiao Lin, Bo Yan, Libo Zhang, Jiamou Liu, Neset \"{O}zkan Tan, Michael Witbrock. {\em Thirty-Eighth AAAI Conference on Artificial Intelligence.} \textbf{AAAI 2024.} (Core A*)\\
	...
	\item {\bf Density-based Correlated Equilibrium for Markov Games.}\\
		Libo Zhang, \textbf{Yang Chen} (contact author, equal contribution), Toru Takisaka, Bakh Khoussainov, Michael Witbrock, Jiamou Liu. {\em The 22nd International Conference on Autonomous Agents and Multi-agent Systems.} \textbf{AAMAS 2023.} (Core A*)\\
...
\end{rSubsection}
\begin{rSubsection}{\large\em $\bullet$ Datasets}{}{}{}
