...
\begin{rSubsection}{\large\em $\bullet$ Reinforcement Learning, Multi-agent Systems \& Game Theory}{}{}{}
	...
	\item {\bf Density-based Correlated Equilibrium for Markov Games.}\\
		Libo Zhang, \textbf{Yang Chen (co-first \& contact author)}, Toru Takisaka, Bakh Khoussainov, Michael Witbrock, Jiamou Liu. {\em The 22nd International Conference on Autonomous Agents and Multi-agent Systems.} \textbf{AAMAS 2023.} (Core A*)\\
