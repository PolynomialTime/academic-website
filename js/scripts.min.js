if (function(t, e) {
    ...
    function u(t, e, n, i) {
        if (At(t)) {
            ...
            if (c && l[c] && (i || l[c].data) || void 0 !== n || "string" != typeof e)
                return c || (c = a ? t[s] = et.pop() || ht.guid++ : s), l[c] || (l[c] = a ? {} : {
                    toJSON: ht.noop
        ...
        if (At(t)) {
            ...
            if (s[a]) {
                if (e && (i = n ? s[a] : s[a].data)) {
                    ht.isArray(e) ? e = e.concat(ht.map(e, ht.camelCase)) : e in i ? e = [e] : (e = ht.camelCase(e), e = e in i ? [e] : e.split(" ")),
                    o = e.length;
                    for (; o--;)
                        delete i[e[o]];
        ...
        for (var r, s, a, l, c, u, d, h = t.length, v = p(e), y = [], w = 0; h > w; w++)
            if ((s = t[w]) || 0 === s)
                if ("object" === ht.type(s))
                    ...
                    for (l = l || v.appendChild(e.createElement("div")), c = (Ht.exec(s) || ["", ""])[1].toLowerCase(), d = Ft[c] || Ft._default, l.innerHTML = d[1] + ht.htmlPrefilter(s) + d[2], r = d[0]; r--;)
                        l = l.lastChild;
                    ...
                    for (ht.merge(y, l.childNodes), l.textContent = ""; l.firstChild;)
    ...
    function k(t, e, n, i) {
        ...
        if (d && (c = v(e, t[0].ownerDocument, !1, t, i), o = c.firstChild, 1 === c.childNodes.length && (c = o), o || i)) {
            for (s = (a = ht.map(f(c, "script"), T)).length; d > u; u++)
                r = c,
                u !== h && (r = ht.clone(r, !0, !0), s && ht.merge(a, f(r, "script"))),
                n.call(t[u], r, u);
            if (s)
                for (l = a[a.length - 1].ownerDocument, ht.map(a, S), u = 0; s > u; u++)
                    r = a[u],
    ...
    function $(t, e, n) {
        for (var i, o = e ? ht.filter(e, t) : t, r = 0; null != (i = o[r]); r++)
            ...
            i.parentNode && (n && ht.contains(i.ownerDocument, i) && g(f(i, "script")), i.parentNode.removeChild(i));
        return t
    }
    function N(t, e) {
    ...
    function D(t, e) {
        for (var n, i, o, r = [], s = 0, a = t.length; a > s; s++)
            (i = t[s]).style && (r[s] = ht._data(i, "olddisplay"), n = i.style.display, e ? (r[s] || "none" !== n || (i.style.display = ""), "" === i.style.display && Mt(i) && (r[s] = ht._data(i, "olddisplay", A(i.nodeName)))) : (o = Mt(i), (n && "none" !== n || !o) && ht._data(i, "olddisplay", o ? n : ht.css(i, "display"))));
        for (s = 0; a > s; s++)
    ...
    function L(t, e, n, i, o) {
        for (var r = n === (i ? "border" : "content") ? 4 : "width" === e ? 1 : 0, s = 0; 4 > r; r += 2)
            ...
            i ? ("content" === n && (s -= ht.css(t, "padding" + Lt[r], !0, o)), "margin" !== n && (s -= ht.css(t, "border" + Lt[r] + "Width", !0, o))) : (s += ht.css(t, "padding" + Lt[r], !0, o), "padding" !== n && (s += ht.css(t, "border" + Lt[r] + "Width", !0, o)));
        return s
    }
    function M(t, e, n) {
        var i = !0,
        ...
        if (0 >= o || null == o) {
            if ((0 > (o = he(t, e, r)) || null == o) && (o = t.style[e]), le.test(o))
                return o;
    ...
    function q(t, e, n) {
        ...
        for (R(u, c.opts.specialEasing); s > r; r++)
            if (i = q.prefilters[r].call(c, t, u, c.opts))
                return ht.isFunction(i.stop) && (ht._queueHooks(c.elem, c.opts.queue).stop = ht.proxy(i.stop, i)), i;
        ...
        for ("boolean" == typeof s && (c = s, s = arguments[a] || {}, a++), "object" == typeof s || ht.isFunction(s) || (s = {}), a === l && (s = this, a--); l > a; a++)
            if (null != (o = arguments[a]))
                for (i in o)
                    t = s[i],
                    n = o[i],
                    s !== n && (c && n && (ht.isPlainObject(n) || (e = ht.isArray(n))) ? (e ? (e = !1, r = t && ht.isArray(t) ? t : []) : r = t && ht.isPlainObject(t) ? t : {}, s[i] = ht.extend(c, r, n)) : void 0 !== n && (s[i] = n));
        return s
    },
    ht.extend({
    ...
    var vt = function(t) {
            ...
            if (!i && ((e ? e.ownerDocument || e : z) !== A && N(e), e = e || A, O)) {
                ...
                if (w.qsa && !F[t + " "] && (!D || !D.test(t))) {
                    if (1 !== g)
                        ...
                        for ((a = e.getAttribute("id")) ? a = a.replace(vt, "\\$&") : e.setAttribute("id", a = j), r = (h = T(t)).length, c = ut.test(a) ? "#" + a : "[id='" + a + "']"; r--;)
                            h[r] = c + " " + u(h[r]);
                        p = h.join(","),
        ...
        function d(t, e, n) {
            ...
            return e.first ? function(e, n, r) {
                ...
                if (s) {
                    ...
                    for (; e = e[i];)
                        if (1 === e.nodeType || o) {
                            if (c = e[j] || (e[j] = {}), l = c[e.uniqueID] || (c[e.uniqueID] = {}), (a = l[i]) && a[0] === H && a[1] === r)
                                return u[2] = a[2];
        ...
        function g(t, e, n, o, r, s) {
            return o && !o[j] && (o = g(o)), r && !r[j] && (r = g(r, s)), i(function(i, s, a, l) {
                var c,
                    ...
                    w = n ? r || (i ? t : m || o) ? [] : s : y;
                if (n && n(y, w, a, l), o)
                    for (c = f(w, g), o(c, [], a, l), u = c.length; u--;)
                        (d = c[u]) && (w[g[u]] = !(y[g[u]] = d));
                if (i) {
                    if (r || t) {
                        if (r) {
        ...
        e.matchesSelector = function(t, n) {
            if ((t.ownerDocument || t) !== A && N(t), n = n.replace(lt, "='$1']"), w.matchesSelector && O && !F[n + " "] && (!P || !P.test(n)) && (!D || !D.test(n)))
                try {
                    var i = L.call(t, n);
        ...
        return c.prototype = b.filters = b.pseudos, b.setFilters = new c, T = e.tokenize = function(t, n) {
            ...
            for (a = t, l = [], c = b.preFilter; a;) {
                ...
                for (s in b.filter)
                    !(o = dt[s].exec(a)) || c[s] && !(o = c[s](o)) || (i = o.shift(), r.push({
                        value: i,
                        type: s,
                        matches: o
                    }), a = a.slice(i.length));
    ...
    ht.ready.promise = function(e) {
        if (!$t)
            if ($t = ht.Deferred(), "complete" === nt.readyState || "loading" !== nt.readyState && !nt.documentElement.doScroll)
        ...
        data: function(t, e) {
            ...
            if (void 0 === t) {
                if (this.length && (o = ht.data(r), 1 === r.nodeType && !ht._data(r, "parsedAttrs"))) {
                    for (n = s.length; n--;)
                        s[n] && 0 === (i = s[n].name).indexOf("data-") && (i = ht.camelCase(i.slice(5)), l(r, i, o[i]));
    ...
    ht.fn.extend({
        ...
        promise: function(t, e) {
            ...
            for ("string" != typeof t && (e = t, t = void 0), t = t || "fx"; s--;)
                (n = ht._data(r[s], t + "queueHooks")) && n.empty && (i++, n.empty.add(a));
    ...
    !function() {
        ...
        for (e in {
            ...
            n = "on" + e,
            (ut[e] = n in t) || (i.setAttribute(n, "t"), ut[e] = !1 === i.attributes[n].expando);
        i = null
    }();
    ...
    ht.event = {
        ...
        add: function(t, e, n, i, o) {
            ...
            if (m) {
                ...
                }, u.elem = t), a = (e = (e || "").match(kt) || [""]).length; a--;)
                    r = Gt.exec(e[a]) || [],
                    p = g = r[1],
                    f = (r[2] || "").split(".").sort(),
                    p && (c = ht.event.special[p] || {}, p = (o ? c.delegateType : c.bindType) || p, c = ht.event.special[p] || {}, d = ht.extend({
                        type: p,
                        origType: g,
                        data: i,
                        handler: n,
            ...
            if (m && (u = m.events)) {
                for (c = (e = (e || "").match(kt) || [""]).length; c--;)
                    if (a = Gt.exec(e[c]) || [], p = g = a[1], f = (a[2] || "").split(".").sort(), p) {
                        for (d = ht.event.special[p] || {}, h = u[p = (i ? d.delegateType : d.bindType) || p] || [], a = a[2] && new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)"), l = r = h.length; r--;)
                            s = h[r],
                            !o && g !== s.origType || n && n.guid !== s.guid || a && !a.test(s.namespace) || i && i !== s.selector && ("**" !== i || !s.selector) || (h.splice(r, 1), s.selector && h.delegateCount--, d.remove && d.remove.call(t, s));
        ...
        trigger: function(e, n, i, o) {
            ...
            if (a = u = i = i || nt, 3 !== i.nodeType && 8 !== i.nodeType && !Yt.test(p + ht.event.triggered) && (p.indexOf(".") > -1 && (f = p.split("."), p = f.shift(), f.sort()), s = p.indexOf(":") < 0 && "on" + p, e = e[ht.expando] ? e : new ht.Event(p, "object" == typeof e && e), e.isTrigger = o ? 2 : 3, e.namespace = f.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + f.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = i), n = null == n ? [e] : ht.makeArray(n, [e]), c = ht.event.special[p] || {}, o || !c.trigger || !1 !== c.trigger.apply(i, n))) {
                if (!o && !c.noBubble && !ht.isWindow(i)) {
                    for (l = c.delegateType || p, Yt.test(l + p) || (a = a.parentNode); a; a = a.parentNode)
                        h.push(a),
                        u = a;
                ...
                for (d = 0; (a = h[d++]) && !e.isPropagationStopped();)
                    ...
                    (r = s && a[s]) && r.apply && At(a) && (e.result = r.apply(a, n), !1 === e.result && e.preventDefault());
            ...
            if (a[0] = t, t.delegateTarget = this, !c.preDispatch || !1 !== c.preDispatch.call(this, t)) {
                for (s = ht.event.handlers.call(this, t, l), e = 0; (o = s[e++]) && !t.isPropagationStopped();)
                    for (t.currentTarget = o.elem, n = 0; (r = o.handlers[n++]) && !t.isImmediatePropagationStopped();)
                        t.rnamespace && !t.rnamespace.test(r.namespace) || (t.handleObj = r, t.data = r.data, void 0 !== (i = ((ht.event.special[r.origType] || {}).handle || r.handler).apply(o.elem, a)) && !1 === (t.result = i) && (t.preventDefault(), t.stopPropagation()));
        ...
        fix: function(t) {
            ...
            var e,
                ...
                r = t,
                s = this.fixHooks[o];
            for (s || (this.fixHooks[o] = s = Vt.test(o) ? this.mouseHooks : Qt.test(o) ? this.keyHooks : {}), i = s.props ? this.props.concat(s.props) : this.props, t = new ht.Event(r), e = i.length; e--;)
                n = i[e],
                t[n] = r[n];
    ...
    ht.extend({
        ...
        clone: function(t, e, n) {
            ...
            if (ut.html5Clone || ht.isXMLDoc(t) || !Kt.test("<" + t.nodeName + ">") ? r = t.cloneNode(!0) : (oe.innerHTML = t.outerHTML, oe.removeChild(r = oe.firstChild)), !(ut.noCloneEvent && ut.noCloneChecked || 1 !== t.nodeType && 11 !== t.nodeType || ht.isXMLDoc(t)))
                for (i = f(r), a = f(t), s = 0; null != (o = a[s]); ++s)
                    i[s] && E(o, i[s]);
            if (e)
                if (n)
                    for (a = a || f(t), i = i || f(r), s = 0; null != (o = a[s]); s++)
                        _(o, i[s]);
                else
                    _(t, r);
        ...
        html: function(t) {
            return jt(this, function(t) {
                ...
                if ("string" == typeof t && !te.test(t) && (ut.htmlSerialize || !Kt.test(t)) && (ut.leadingWhitespace || !Rt.test(t)) && !Ft[(Ht.exec(t) || ["", ""])[1].toLowerCase()]) {
                    ...
                    try {
                        for (; i > n; n++)
                            1 === (e = this[n] || {}).nodeType && (ht.cleanData(f(e, !1)), e.innerHTML = t);
                        e = 0
                    } catch (t) {}
                }
    ...
    !function() {
        function e() {
            ...
            n = o = a = !1,
            i = s = !0,
            t.getComputedStyle && (u = t.getComputedStyle(c), n = "1%" !== (u || {}).top, a = "2px" === (u || {}).marginLeft, o = "4px" === (u || {
                width: "4px"
            ...
            (r = 0 === c.getClientRects().length) && (c.style.display = "", c.innerHTML = "<table><tr><td></td><td>t</td></tr></table>", c.childNodes[0].style.borderCollapse = "separate", e = c.getElementsByTagName("td"), e[0].style.cssText = "margin:0;border:0;padding:0;display:none", (r = 0 === e[0].offsetHeight) && (e[0].style.display = "", e[1].style.display = "none", r = 0 === e[0].offsetHeight)),
            d.removeChild(l)
        }
        var n,
            i,
        ...
        style: function(t, e, n, i) {
            if (t && 3 !== t.nodeType && 8 !== t.nodeType && t.style) {
                var o,
                    ...
                    a = ht.camelCase(e),
                    l = t.style;
                if (e = ht.cssProps[a] || (ht.cssProps[a] = O(a) || a), s = ht.cssHooks[e] || ht.cssHooks[a], void 0 === n)
                    return s && "get" in s && void 0 !== (o = s.get(t, !1, i)) ? o : l[e];
                if ("string" === (r = typeof n) && (o = Pt.exec(n)) && o[1] && (n = h(t, e, o), r = "number"), null != n && n === n && ("number" === r && (n += o && o[3] || (ht.cssNumber[a] ? "" : "px")), ut.clearCloneStyle || "" !== n || 0 !== e.indexOf("background") || (l[e] = "inherit"), !(s && "set" in s && void 0 === (n = s.set(t, n, i)))))
                    try {
                        l[e] = n
                    } catch (t) {}
            }
    ...
    ut.opacity || (ht.cssHooks.opacity = {
        ...
        set: function(t, e) {
            ...
            n.zoom = 1,
            (e >= 1 || "" === e) && "" === ht.trim(r.replace(fe, "")) && n.removeAttribute && (n.removeAttribute("filter"), "" === e || i && !i.filter) || (n.filter = fe.test(r) ? r.replace(fe, o) : r + " " + o)
        }
    }),
    ...
    ht.Animation = ht.extend(q, {
        ...
        prefilters: [function(t, e, n) {
            ...
            1 === t.nodeType && ("height" in e || "width" in e) && (n.overflow = [h.overflow, h.overflowX, h.overflowY], "inline" === ("none" === (c = ht.css(t, "display")) ? ht._data(t, "olddisplay") || A(t.nodeName) : c) && "none" === ht.css(t, "float") && (ut.inlineBlockNeedsLayout && "inline" !== A(t.nodeName) ? h.zoom = 1 : h.display = "inline-block")),
            n.overflow && (h.overflow = "hidden", ut.shrinkWrapBlocks() || u.always(function() {
            ...
            if (ht.isEmptyObject(d))
                ...
                for (i in d)
                    s = W(p ? f[i] : 0, i, u),
                    i in f || (f[i] = s.start, p && (s.end = s.start, s.start = "width" === i || "height" === i ? 1 : 0))
            }
        }],
        ...
        finish: function(t) {
            return !1 !== t && (t = t || "fx"), this.each(function() {
                var e,
                    ...
                    r = ht.timers,
                    s = i ? i.length : 0;
                for (n.finish = !0, ht.queue(this, t, []), o && o.stop && o.stop.call(this, !0), e = r.length; e--;)
            ...
            select: {
                ...
                set: function(t, e) {
                    for (var n, i, o = t.options, r = ht.makeArray(e), s = o.length; s--;)
                        if (i = o[s], ht.inArray(ht.valHooks.option.get(i), r) > -1)
                            try {
                                i.selected = n = !0
                            } catch (t) {
                                i.scrollHeight
    ...
    ht.extend({
        attr: function(t, e, n) {
            var i,
                ...
                r = t.nodeType;
            if (3 !== r && 8 !== r && 2 !== r)
                return void 0 === t.getAttribute ? ht.prop(t, e, n) : (1 === r && ht.isXMLDoc(t) || (e = e.toLowerCase(), o = ht.attrHooks[e] || (ht.expr.match.bool.test(e) ? Ne : $e)), void 0 !== n ? null === n ? void ht.removeAttr(t, e) : o && "set" in o && void 0 !== (i = o.set(t, n, e)) ? i : (t.setAttribute(e, n + ""), n) : o && "get" in o && null !== (i = o.get(t, e)) ? i : null == (i = ht.find.attr(t, e)) ? void 0 : i)
        },
        attrHooks: {
            type: {
                set: function(t, e) {
        ...
        toggleClass: function(t, e) {
            ...
            return "boolean" == typeof e && "string" === n ? e ? this.addClass(t) : this.removeClass(t) : ht.isFunction(t) ? this.each(function(n) {
                ...
                var e,
                    ...
                    r;
                if ("string" === n)
                    for (i = 0, o = ht(this), r = t.match(kt) || []; e = r[i++];)
                        o.hasClass(e) ? o.removeClass(e) : o.addClass(e);
                else
                    void 0 !== t && "boolean" !== n || ((e = F(this)) && ht._data(this, "__className__", e), ht.attr(this, "class", e || !1 === t ? "" : ht._data(this, "__className__") || ""))
            })
        },
        hasClass: function(t) {
            var e,
    ...
    ht.extend({
        ...
        ajax: function(e, n) {
            ...
            for (r in {
                ...
                C[r](h[r]);
            if (u = U(Ye, h, n, C)) {
                if (C.readyState = 1, c && f.trigger("ajaxSend", [C, h]), 2 === b)
                    return C;
    ...
    ht.param = function(t, e) {
        ...
        if (void 0 === e && (e = ht.ajaxSettings && ht.ajaxSettings.traditional), ht.isArray(t) || t.jquery && !ht.isPlainObject(t))
            ht.each(t, function() {
                ...
                send: function(i, o) {
                    ...
                    n = function(t, i) {
                        ...
                        if (n && (i || 4 === s.readyState))
                            if (delete sn[a], n = void 0, s.onreadystatechange = ht.noop, i)
    ...
    ht.offset = {
        setOffset: function(t, e, n) {
            ...
            r = ht.css(t, "top"),
            l = ht.css(t, "left"),
            ("absolute" === c || "fixed" === c) && ht.inArray("auto", [r, l]) > -1 ? (i = u.position(), s = i.top, o = i.left) : (s = parseFloat(r) || 0, o = parseFloat(l) || 0),
    ...
    o.prototype = {
        ...
        _findParticles: function() {
            ...
            this.options.parallaxElements && this.$element.find("[data-stellar-ratio]").each(function() {
                ...
                h.data("stellar-startingLeft") ? (h.css("left", h.data("stellar-startingLeft")), h.css("top", h.data("stellar-startingTop"))) : (h.data("stellar-startingLeft", h.css("left")), h.data("stellar-startingTop", h.css("top"))),
                r = h.position().left,
                s = h.position().top,
        ...
        _findBackgrounds: function() {
            ...
            this.options.parallaxBackgrounds && (e = this.$element.find("[data-stellar-background-ratio]"), this.$element.data("stellar-background-ratio") && (e = e.add(this.$element)), e.each(function() {
                ...
                f.data("stellar-backgroundStartingLeft") ? d(f, f.data("stellar-backgroundStartingLeft"), f.data("stellar-backgroundStartingTop")) : (f.data("stellar-backgroundStartingLeft", g[0]), f.data("stellar-backgroundStartingTop", g[1])),
        ...
        _setOffsets: function() {
            ...
            "function" == typeof this.options.horizontalOffset ? (this.horizontalOffset = this.options.horizontalOffset(), i.bind("resize.horizontal-" + this.name, function() {
                n.horizontalOffset = n.options.horizontalOffset()
            })) : this.horizontalOffset = this.options.horizontalOffset,
            "function" == typeof this.options.verticalOffset ? (this.verticalOffset = this.options.verticalOffset(), i.bind("resize.vertical-" + this.name, function() {
        ...
        _repositionElements: function() {
            ...
            if (this.currentScrollLeft !== u || this.currentScrollTop !== h || this.currentWidth !== this.viewportWidth || this.currentHeight !== this.viewportHeight) {
                for (this.currentScrollLeft = u, this.currentScrollTop = h, this.currentWidth = this.viewportWidth, this.currentHeight = this.viewportHeight, c = this.particles.length - 1; c >= 0; c--)
                    t = this.particles[c],
                    e = t.isFixed ? 1 : 0,
                    this.options.horizontalScrolling ? (r = (u + t.horizontalOffset + this.viewportOffsetLeft + t.startingPositionLeft - t.startingOffsetLeft + t.parentOffsetLeft) * -(t.stellarRatio + e - 1) + t.startingPositionLeft, a = r - t.startingPositionLeft + t.startingOffsetLeft) : (r = t.startingPositionLeft, a = t.startingOffsetLeft),
                    this.options.verticalScrolling ? (s = (h + t.verticalOffset + this.viewportOffsetTop + t.startingPositionTop - t.startingOffsetTop + t.parentOffsetTop) * -(t.stellarRatio + e - 1) + t.startingPositionTop, l = s - t.startingPositionTop + t.startingOffsetTop) : (s = t.startingPositionTop, l = t.startingOffsetTop),
                    this.options.hideDistantElements && (f = !this.options.horizontalScrolling || a + t.width > (t.isFixed ? 0 : u) && a < (t.isFixed ? 0 : u) + this.viewportWidth + this.viewportOffsetLeft, p = !this.options.verticalScrolling || l + t.height > (t.isFixed ? 0 : h) && l < (t.isFixed ? 0 : h) + this.viewportHeight + this.viewportOffsetTop),
                    f && p ? (t.isHidden && (this.options.showElement(t.$element), t.isHidden = !1), this._setPosition(t.$element, r, t.startingPositionLeft, s, t.startingPositionTop)) : t.isHidden || (this.options.hideElement(t.$element), t.isHidden = !0);
    ...
    t.flexslider = function(n, i) {
        ...
        m = {
                ...
                o.transitions = !o.vars.video && !f && o.vars.useCSS && function() {
                    ...
                    for (var n in e)
                        if (void 0 !== t.style[e[n]])
                            return o.pfx = e[n].replace("Perspective", "").toLowerCase(), o.prop = "-" + o.pfx + "-transform", !0;
                    return !1
                }(),
            ...
            asNav: {
                setup: function() {
                    ...
                    a ? (n._slider = o, o.slides.each(function() {
                        var e = this;
            ...
            directionNav: {
                setup: function() {
                    ...
                    o.customDirectionNav ? o.directionNav = o.customDirectionNav : o.controlsContainer ? (t(o.controlsContainer).append(e), o.directionNav = t("." + s + "direction-nav li a", o.controlsContainer)) : (o.append(e), o.directionNav = t("." + s + "direction-nav li a", o)),
                    m.directionNav.update(),
                    o.directionNav.bind(c, function(e) {
                        e.preventDefault();
                        var n;
                        ("" === u || u === e.type) && (n = t(this).hasClass(s + "next") ? o.getTarget("next") : o.getTarget("prev"), o.flexAnimate(n, o.vars.pauseOnAction)),
                        "" === u && (u = e.type),
                        m.setToClearWatchedEvent()
                    })
                },
            ...
            pausePlay: {
                setup: function() {
                    ...
                    o.controlsContainer ? (o.controlsContainer.append(e), o.pausePlay = t("." + s + "pauseplay a", o.controlsContainer)) : (o.append(e), o.pausePlay = t("." + s + "pauseplay a", o)),
                    m.pausePlay.update(o.vars.slideshow ? s + "pause" : s + "play"),
                    o.pausePlay.bind(c, function(e) {
                        e.preventDefault(),
                        ("" === u || u === e.type) && (t(this).hasClass(s + "pause") ? (o.manualPause = !0, o.manualPlay = !1, o.pause()) : (o.manualPause = !1, o.manualPlay = !0, o.play())),
                        "" === u && (u = e.type),
                        m.setToClearWatchedEvent()
                    })
                },
        ...
        o.flexAnimate = function(e, n, i, r, a) {
            if (o.vars.animationLoop || e === o.currentSlide || (o.direction = e > o.currentSlide ? "next" : "prev"), g && 1 === o.pagingCount && (o.direction = o.currentItem < e ? "next" : "prev"), !o.animating && (o.canAdvance(e, a) || i) && o.is(":visible")) {
                if (g && r) {
                    ...
                    if (o.atEnd = 0 === e || e === o.count - 1, c.flexAnimate(e, !0, !1, !0, a), o.direction = o.currentItem < e ? "next" : "prev", c.direction = o.direction, Math.ceil((e + 1) / o.visible) - 1 === o.currentSlide || 0 === e)
                        return o.currentItem = e, o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), !1;
                    o.currentItem = e,
                ...
                if (o.animating = !0, o.animatingTo = e, n && o.pause(), o.vars.before(o), o.syncExists && !a && m.sync("animate"), o.vars.controlNav && m.controlNav.active(), p || o.slides.removeClass(s + "active-slide").eq(e).addClass(s + "active-slide"), o.atEnd = 0 === e || e === o.last, o.vars.directionNav && m.directionNav.update(), e === o.last && (o.vars.end(o), o.vars.animationLoop || o.pause()), f)
                    ...
                    o.transitions ? (o.vars.animationLoop && o.atEnd || (o.animating = !1, o.currentSlide = o.animatingTo), o.container.unbind("webkitTransitionEnd transitionend"), o.container.bind("webkitTransitionEnd transitionend", function() {
        ...
        o.setProps = function(t, e, n) {
            ...
            o.transitions && (i = d ? "translate3d(0," + i + ",0)" : "translate3d(" + i + ",0,0)", n = void 0 !== n ? n / 1e3 + "s" : "0s", o.container.css("-" + o.pfx + "-transition-duration", n), o.container.css("transition-duration", n)),
            o.args[o.prop] = i,
        ...
        o.setup = function(e) {
            if (f)
                ...
                "init" === e && (o.viewport = t('<div class="' + s + 'viewport"></div>').css({
                    overflow: "hidden",
                    position: "relative"
                }).appendTo(o).append(o.container), o.cloneCount = 0, o.cloneOffset = 0, h && (i = t.makeArray(o.slides).reverse(), o.slides = t(i), o.container.empty().append(o.slides))),
                o.vars.animationLoop && !p && (o.cloneCount = 2, o.cloneOffset = 1, "init" !== e && o.container.find(".clone").remove(), o.container.append(m.uniqueID(o.slides.first().clone().addClass("clone")).attr("aria-hidden", "true")).prepend(m.uniqueID(o.slides.last().clone().addClass("clone")).attr("aria-hidden", "true"))),
                o.newSlides = t(o.vars.selector, o),
                n = h ? o.count - 1 - o.currentSlide + o.cloneOffset : o.currentSlide + o.cloneOffset,
                d && !p ? (o.container.height(200 * (o.count + o.cloneCount) + "%").css("position", "absolute").width("100%"), setTimeout(function() {
                    o.newSlides.css({
                        display: "block"
                    }),
                    o.doMath(),
        ...
        o.doMath = function() {
            ...
            p ? (o.itemT = o.vars.itemWidth + e, o.itemM = e, o.minW = n ? n * o.itemT : o.w, o.maxW = i ? i * o.itemT - e : o.w, o.itemW = o.minW > o.w ? (o.w - e * (n - 1)) / n : o.maxW < o.w ? (o.w - e * (i - 1)) / i : o.vars.itemWidth > o.w ? o.w : o.vars.itemWidth, o.visible = Math.floor(o.w / o.itemW), o.move = o.vars.move > 0 && o.vars.move < o.visible ? o.vars.move : o.visible, o.pagingCount = Math.ceil((o.count - o.visible) / o.move + 1), o.last = o.pagingCount - 1, o.limit = 1 === o.pagingCount ? 0 : o.vars.itemWidth > o.w ? o.itemW * (o.count - 1) + e * (o.count - 1) : (o.itemW + e) * o.count - o.w - e) : (o.itemW = o.w, o.itemM = e, o.pagingCount = o.count, o.last = o.count - 1),
        ...
        o.update = function(t, e) {
            ...
            o.vars.controlNav && !o.manualControls && ("add" === e && !p || o.pagingCount > o.controlNav.length ? m.controlNav.update("add") : ("remove" === e && !p || o.pagingCount < o.controlNav.length) && (p && o.currentSlide > o.last && (o.currentSlide -= 1, o.animatingTo -= 1), m.controlNav.update("remove", o.last))),
    ...
    t.fn.countTo = function(n) {
        return this.each(function() {
            ...
            r && (o && o.stop(), i.data("countTo", o = new e(this, s))),
            o[a].call(o)
        })
    }
}), function(t) {
    ...
    var e,
        ...
        T = function(n, i) {
            ...
            e.st.callbacks && (n = n.charAt(0).toLowerCase() + n.slice(1), e.st.callbacks[n] && e.st.callbacks[n].apply(e, t.isArray(i) ? i : [i]))
        },
        S = function(n) {
            ...
            getInline: function(n, i) {
                if (I(), n.src) {
                    ...
                    if (r.length) {
                        ...
                        s && s.tagName && ($ || (k = o.hiddenClass, $ = C(k), k = "mfp-" + k), N = r.after($).detach().removeClass(k)),
            ...
            initGallery: function() {
                ...
                return e.direction = !0, !(!n || !n.enabled) && (s += " mfp-gallery", x(d + i, function() {
                    ...
                    if (e.items.length > 1 && n.arrows && !e.arrowLeft) {
                        ...
                        e.isIE7 && (C("b", o[0], !1, !0), C("a", o[0], !1, !0), C("b", s[0], !1, !0), C("a", s[0], !1, !0)),
                ...
                if (e) {
                    ...
                    s.on("touchstart" + i, function(t) {
                        ...
                        b.on("touchmove" + i, function(t) {
                            ...
                            h = d.length,
                            d = d[0],
                            (Math.abs(d.clientX - l) > 10 || Math.abs(d.clientY - c) > 10) && (u = !0, n())
                        }).on("touchend" + i, function(t) {
                            n(),
                            u || h > 1 || (r = !0, t.preventDefault(), clearTimeout(a), a = setTimeout(function() {
                                r = !1
                            }, 1e3), o())
                        })
                    })
    ...
    o.Pipe = [{
        ...
        run: function() {
            ...
            for (t = 0, e = Math.abs(o / 2); e > t; t++)
                o > 0 ? (this.$stage.children().eq(i.length + n.length - 1).remove(), n.pop(), this.$stage.children().eq(0).remove(), n.pop()) : (n.push(n.length / 2), this.$stage.append(i[n[n.length - 1]].clone().addClass("cloned")), n.push(i.length - 1 - (n.length - 1) / 2), this.$stage.prepend(i[n[n.length - 1]].clone().addClass("cloned")))
        }
    }, {
        filter: ["width", "items", "settings"],
        run: function() {
    ...
    o.prototype.initialize = function() {
        if (this.trigger("initialize"), this.$element.addClass(this.settings.baseClass).addClass(this.settings.themeClass).toggleClass("owl-rtl", this.settings.rtl), this.browserSupport(), this.settings.autoWidth && !0 !== this.state.imagesLoaded) {
            var e,
                n,
                o;
            if (e = this.$element.find("img"), n = this.settings.nestedItemSelector ? "." + this.settings.nestedItemSelector : i, o = this.$element.children(n).width(), e.length && 0 >= o)
    ...
    o.prototype.onDragEnd = function(e) {
        ...
        if (this.state.isTouch) {
            if ("mouseup" === e.type && this.$stage.removeClass("owl-grab"), this.trigger("dragged"), this.drag.targetEl.removeAttribute("draggable"), this.state.isTouch = !1, this.state.isScrolling = !1, this.state.isSwiping = !1, 0 === this.drag.distance && !0 !== this.state.inMotion)
                return this.state.inMotion = !1, !1;
    ...
    o.prototype.maximum = function(t) {
        ...
        if (!r.loop && r.center)
            ...
            if (r.loop || r.center)
                ...
                for (revert = r.rtl ? 1 : -1, n = this.$stage.width() - this.$element.width(); (i = this.coordinates(o)) && !(i * revert >= n);)
                    e = ++o
            }
        else
            e = this._items.length - r.items;
    ...
    e.prototype.update = function() {
        ...
        if ("page" !== n.slideBy && (n.slideBy = Math.min(n.slideBy, n.items)), n.dots || "page" == n.slideBy)
            for (this._pages = [], t = i, e = 0, 0; o > t; t++)
    ...
    e.prototype.refresh = function() {
        ...
        for (var r in t) {
            ...
            for (var a in this.waypoints[r]) {
                ...
                d = c && u,
                h = !c && !u,
                !v && d ? (p.queueTrigger(s.backward), i[p.group.id] = p.group) : !v && h ? (p.queueTrigger(s.forward), i[p.group.id] = p.group) : v && s.oldScroll >= p.triggerPoint && (p.queueTrigger(s.forward), i[p.group.id] = p.group)
            }
        }
